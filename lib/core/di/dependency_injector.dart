...
void injectionSetup() {
  ...
  // Register VideoControllerCacheService
  getIt.registerLazySingleton(() => VideoControllerCacheService());

  // Register VideoStateService
  getIt.registerLazySingleton(() => VideoStateService());
